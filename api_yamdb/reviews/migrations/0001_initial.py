# Generated by Django 2.2.16 on 2023-04-03 17:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator('^[-a-zA-Z0-9_]+$')], verbose_name='Слаг')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=0, validators=[reviews.validators.title_year_validator], verbose_name='Год написания')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('title', 'genre'), name='unique_title_AK'),
        ),
        migrations.AddConstraint(
            model_name='review',
